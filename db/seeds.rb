...
jogo_um = Event.create!(start_time: DateTime.new(2025,2,3,4,5,6), end_time: DateTime.new(2025,2,3,6,5,6), description: "Game between White Star and Louvain-la-neuve @Main field", title: "White Star vs Louvain-la-Neuve", location_id: main_field.id, team_id: first_team.id, address: 'Cantersteen 12, 1000 Bruxelles' )
...
jogo_dois = Event.create!(start_time: DateTime.new(2025,2,3,4,5,6), end_time: DateTime.new(2025,2,3,6,5,6), description: "Game between Louvain-la-Neuve and White Star @Louvain-la-Neuve hockey stadium", title: "Louvain-la-Neuve vs White Star", team_id: first_hockey_team.id, address: 'Cantersteen 12, 1000 Bruxelles' )
